...
function togglePopup() {
    page.popup.index.classList.contains('cover_hidden')
...
function rerenderContent(activeHabbit) {
    ...
    for (const index in activeHabbit.days) {
        ...
        element.innerHTML = `<div class="habbit__day">День ${+index + 1}</div>
            ...
            <button class="habbit__delete" onclick="deleteDay(${index})" type="button">
...
function deleteDay(index) {
    ...
    // другой вариант
    habbits[globalActiveHabbitId - 1].days.splice(index, 1);
